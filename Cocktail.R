...
fg_col <- rgb(235, 232, 227, maxColorValue = 255)
bg_col <- rgb(30, 30, 60, maxColorValue = 255)
line_col <- rgb(16, 14, 46, maxColorValue = 255)
...
ggplot(top10, aes(ingredient, n)) +
  ...
  theme(axis.text.x = element_text(angle = 45,
        ...
        plot.background = element_rect(fill = line_col),
